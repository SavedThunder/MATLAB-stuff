...
for k = 1:10000
    Res_Value_1 = Res1 + (Tol1 * Res1)/2 * randn(1);
    Res_Value_2 = Res2 + (Tol2 * Res2)/2 * randn(1);
    Vector_1(k) = (Res_Value_1/(Res_Value_1+Res_Value_2))* SoVol;
    Vector_2(k) = (Res_Value_2/(Res_Value_1+Res_Value_2))* SoVol;
